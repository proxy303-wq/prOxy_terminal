...
#   FUTURES  REMOVED (disarmed 09-Sep fresh start; worker loop deleted below -
#            code stays in the repo but nothing starts it)
#   BANKNIFTY DISABLED (loop removed; mode_banknifty.json deleted 06-Sep)
# Monthly target: 12.5% of 7L across the engines that run.
